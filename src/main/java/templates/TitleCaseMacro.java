package templates; // Copyright 2000-2022 JetBrains s.r.o. and other contributors. Use of this
...
public class TitleCaseMacro extends MacroBase {
    ...
    protected Result calculateResult(
            Expression @NotNull [] params, ExpressionContext context, boolean quick) {
    ...
    public boolean isAcceptableInContext(TemplateContextType context) {
        return (context instanceof HiveLiveTemplateContext);
    }
}
